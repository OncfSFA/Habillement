    ...
    public partial class ConsultationPolHab : System.Web.UI.Page
    {
        ...
        protected void DDLDirection_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (DDLStatut.SelectedValue == "5")
            {
                ...
                else
                {
                    ...
                    msg.Text = "<b>Les prévisions ne sont pas validées pour cette Direction  </b>";
        ...
        protected void DDLEtablissementMere_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (DDLStatut.SelectedValue == "5")
            {
                ...
                {
                    title.InnerHtml = "Message";
                    msg.Text = "<b>Les prévisions ne sont pas validées pour cet Etablissement  </b>";
                    ModalPopupExtender2.Show();
                    GDVArticle.DataSource = null;
                    GDVArticle.DataBind();
                }
            ...
            {
                DataSet dsPrevision = BLLPrevision.GetAgentRejetHabil(DDLEtablissementMere.SelectedValue);
                if (dsPrevision.Tables[0].Rows.Count != 0)
                {
                    GDVRejet.DataSource = dsPrevision;
                    GDVRejet.DataBind();
                ...
                {
                    title.InnerHtml = "Message";
                    msg.Text = "<b>Les prévisions ne sont pas rejetées pour cet Etablissement  </b>";
                    ModalPopupExtender2.Show();
                    GDVRejet.DataSource = null ;
                    GDVRejet.DataBind();
                   // exporter.Visible = false;
