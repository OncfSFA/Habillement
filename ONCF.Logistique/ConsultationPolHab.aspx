        ...
        <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender5" runat="server" 
            Enabled="True" PopupPosition="right" TargetControlID="CompareValidator1">
               ...
               Width="100%"   BorderStyle="None"  >
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr style="background-color: #fbb17f; width: 100%; height: 30px" align="center">
                                                            <th width="50%">
                                                             ...
                                                             <th width="10%" runat ="server" id="idtt" visible ='<%# visibilite() %>'>
                                                      ...
                                                      --
                                                           <%-- </td>
                                                            ...
                                                            <td width="10%">                   
                                                             ...
                                                             <td width="10%" runat ="server" id="idt" visible ='<%# visibilite() %>'>                   
                    ...
                    <asp:GridView ID="GDVRejet" runat="server" AutoGenerateColumns="False" 
               Width="100%"   BorderStyle="None"  >
                                        <Columns>
                                            <asp:TemplateField>
                                                <HeaderTemplate>
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr style="background-color: #fbb17f; width: 100%; height: 30px" align="center">
                                                             ...
                                                             <th width="50%">
                                                                <asp:Label ID="LblNomEnClature1" runat="server" Text="Matricule" Font-Size="15px" ForeColor="White"></asp:Label>
                                                            </th>
                                                             <th width="50%">
                                                                <asp:Label ID="LblDesignation1" runat="server" Text="Fonction" Font-Size="15px" ForeColor="White"></asp:Label>
                                                            </th>
                                                ...
                                                <ItemTemplate>
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                        <tr width="100%" align="center" >
                                                            <td width="50%">                   
                                                                <asp:Label ID="LblDesignation" runat="server" Text='<%# Eval("MATRICULE") %>' ></asp:Label>
                                                             </td> 
                                                              <td width="50%">
                                                               <asp:Label ID="LblNomEnClature" runat="server" Text='<%# Eval("LIB_FCT") %>' ></asp:Label>
                                                            </td>                                                           
